...
const Box = (props) => {
  ...
  const {style, d, m, mt, mb, ml, mr, mx, my, p, pt, pb, pl, pr, py, px,  textAlign, alignItems,  alignContent, justify, alignSelf, tag: Tag, className, ...attributes } = props
  ...
  return <Tag data-test="box" className={classes} style={styles} {...attributes}> {props.children} </Tag>
}
